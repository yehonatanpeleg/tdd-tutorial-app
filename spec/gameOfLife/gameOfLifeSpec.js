describe("Generate Game Of Life Grid", function name() {
  const generateGrid = require("../../src/gameOfLife/gameOfLife").generateGrid;
...
describe("Retrieve Cell And Neighbors", function name() {
  const generateGrid = require("../../src/gameOfLife/gameOfLife").generateGrid;
  const retrieveCellNeighbors = require("../../src/gameOfLife/gameOfLife")
...
describe("Retrieve next generation", function name() {
  ...
  const retrieveCellNeighbors = require("../../src/gameOfLife/gameOfLife")
    .retrieveCellNeighbors;
  const retrieveNextGeneration = require("../../src/gameOfLife/gameOfLife")
